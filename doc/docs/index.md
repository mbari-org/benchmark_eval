This is MBARI documentation for creating benchmark datasets and evaluating models using HOTA. MBARI benchmark_eval Github repository [here](https://github.com/mbari-org/benchmark_eval).
